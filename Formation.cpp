...
Formation::Formation(const string &n) : name(n) {
    if (n == "433") {
        ...
        links = {
            {"GK", "RCB"}, {"RCB", "RB"}, {"RB", "RCM"}, {"RCM", "RW"}, {"RW", "ST"}, {"ST", "LW"}, {"LW", "LCM"},
            {"LCM", "LB"},
            {"LB", "LCB"}, {"LCB", "RCB"}, {"LCB", "GK"}, {"LCM", "CDM"}, {"CDM", "RCM"}, {"CDM", "ST"}, {"CDM", "LCB"},
            {"CDM", "RCB"}
        };
    } else if (n == "442") {
        ...
        links = {
            {"GK", "RCB"}, {"RCB", "RB"}, {"RB", "RM"}, {"RM", "RST"}, {"RST", "LST"}, {"LST", "LM"}, {"LM", "LB"},
            {"LB", "LCB"},
            {"LCB", "RCB"}, {"LCB", "GK"}, {"LM", "LCM"}, {"LCM", "RCM"}, {"RCM", "RM"}, {"LST", "LCM"}, {"RST", "RCM"},
            {"LCM", "LCB"}, {"RCM", "RCB"}
        };
    } else if (n == "343") {
        ...
        links = {
            {"GK", "LCB"}, {"GK", "CB"}, {"GK", "RCB"}, {"RCB", "RM"}, {"RM", "RW"}, {"RW", "ST"}, {"ST", "LW"},
            {"LW", "LM"},
            {"LM", "LCB"}, {"LCB", "CB"}, {"CB", "RCB"}, {"CB", "LCM"}, {"CB", "RCM"}, {"LCM", "LM"}, {"RCM", "RM"},
            {"LCM", "RCM"}, {"RCM", "ST"}, {"LCM", "ST"}
        };
    } else if (n == "4321") {
        ...
        links = {
            {"GK", "RCB"}, {"RCB", "RB"}, {"RB", "RCM"}, {"RCM", "RST"}, {"RST", "ST"}, {"ST", "LST"}, {"LST", "LCM"},
            {"LCM", "LB"},
        ...
        coordinates = {
            ...
            {835, 230}, {620, 230}, {1055, 230},
            {730, 100}, {950, 100}
        };
        links = {
            {"GK", "LCB"}, {"GK", "CB"}, {"GK", "RCB"}, {"RCB", "RB"}, {"RB", "RCM"}, {"RCM", "RST"}, {"RST", "LST"},
            {"LST", "LCM"},
            {"LCM", "LB"}, {"LB", "LCB"}, {"LCB", "CB"}, {"CB", "RCB"}, {"LCB", "LCM"}, {"RCB", "RCM"}, {"CB", "CDM"},
            {"CDM", "LCM"}, {"CDM", "RCM"}, {"CDM", "LST"}, {"CDM", "RST"}
        };
    }
}
